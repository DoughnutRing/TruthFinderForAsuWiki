...
class Connection:
    def __init__(self) -> None:
        ...
        self.browser = self.pw.chromium.launch(headless=False, proxy={"server": "120.194.55.139:6969"})
        self.js = """
    ...
    def connect_truth(self, url:str, need_txt = False):
        '实现真相内容的获取'
        # header = self.__get_header()
        prox = self.__get_proxy()

        # page = self.browser.new_page(proxy={
        #     "server" : "http://" + prox['HTTP']
        # })
        # print("http://" + prox['HTTP'])
