...
start_page = random.randint(1, 2000)
for page in range(start_page,start_page+300):
...
outputfile = open('ippool.txt', 'w', encoding='UTF-8')
for ip_valid in can_use:
    outputfile.write(str(ip_valid['HTTP']) + '\n')
outputfile.close()
